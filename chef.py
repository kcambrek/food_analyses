...
st.write("""This is a small project in which I analysed the relations between ingredients based on allrecipes.com dump containing over 250,000 recipes. \
    ...
    Below you can select multiple ingredients and play around with the minimum lift value for the network. Interesting is to see, are the quite tasty relations that have been found \
